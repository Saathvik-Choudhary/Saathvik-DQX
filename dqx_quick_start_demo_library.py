...
# MAGIC %md
# MAGIC # DQX - Use as Library Test
# MAGIC
# MAGIC In this test we validate how to create and apply a set of rules (checks) defined in YAML configuration and using DQX classes. 
# MAGIC
# MAGIC **Note:**
...
# Create a sample DataFrame from open-source data
...
# 1. Ensure total_bill, tip, day are not null or empty (error-level)
- check:
