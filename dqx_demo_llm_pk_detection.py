...
# MAGIC %md
# MAGIC # DQX - LLM-Based Primary Key Detection Test
# MAGIC
# MAGIC This test validates DQX's LLM-based primary key detection capability, which uses AI to automatically identify primary key columns in your tables.
# MAGIC
...
# MAGIC ## Environment
# MAGIC
# MAGIC DQX is installed at the cluster level with `llm` extras.
...
# Use open-source dataset with a synthetic primary key
tips_url = "https://raw.githubusercontent.com/mwaskom/seaborn-data/master/tips.csv"
tips_view = "tips_pk_detection"
...
tips_df.createOrReplaceGlobalTempView(tips_view)

input_table_name = f"global_temp.{tips_view}"
