...
# MAGIC %md
# MAGIC # DQX Workspace Tool Test
# MAGIC ## Environment
# MAGIC
# MAGIC DQX is already installed in the workspace and on the cluster. This notebook validates tool-driven workflows.
# MAGIC
...
# MAGIC   input_config:
# MAGIC     format: delta
# MAGIC     location: https://raw.githubusercontent.com/mwaskom/seaborn-data/master/tips.csv
# MAGIC   output_config:
# MAGIC     format: delta
# MAGIC     location: main.tips.output
# MAGIC     mode: overwrite
# MAGIC   quarantine_config:
# MAGIC     format: delta
# MAGIC     location: main.tips.quarantine
# MAGIC     mode: overwrite
...
# MAGIC %md
# MAGIC You can also profile and run quality checking across multiple tables in a single method call (see multi table test).
